...
function Search(a) {
    ...
    this.search = function (a) {
        ...
        this.lastSearch = a;
        this.results.empty();
        if (1 >= a.length) this.results.html("<i>You must search for a name with a minimum of 2 characters.</i>"); //Regulate length of search parameter
        else {
...
function nodeActive(a) {
    ...
    $GP.info_data.show();
    $GP.info_p.html("Connections (sorted by frequency):");
